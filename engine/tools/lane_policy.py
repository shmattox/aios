...
# A102's links-only FO hygiene exception (is_mechanical_hygiene + the hygiene_links_only param +
# links_only.py) RETIRED 2026-08-21: built but never wired — every production caller passed None, so
# the exception never fired. Removed whole per retire-don't-improve (Fable review, A138 [GATE: human],
# Seth's call). Restore from git history if the FO hygiene lane is ever genuinely wanted.
